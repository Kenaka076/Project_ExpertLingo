        ...
        <div class="bg-blue"> <!-- Hero Section-->
            ...
            <div class="mx-auto place-content-center h-screen w-9/12 text-slate-900">
                <div class="container w-6/12 ">
                    <h2 class="my-4 text-2xl font-semibold">Edit Guru</h2>
                    ...
                    <form method="POST" action="{{ route('guru.update', $guru->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_guru" id="nama_guru" class="mt-1 p-2 w-full border rounded-md" value="{{ $guru->nama_guru }}" required>
                        </div>
                        <div class="mb-4">
                            <label for="phoneNumber" class="block text-sm font-medium text-gray-700">No Telepon</label>
                            <input type="text" name="phoneNumber" id="phoneNumber" class="mt-1 p-2 w-full border rounded-md" value="{{ $guru->phoneNumber }}" required>
                        </div>
            
                        <button type="submit" class="rounded-lg py-2 px-5 bg-blue-600 text-slate-200 hover:bg-slate-500 hover:text-blue-400">Update Guru</button>
                    </form>
